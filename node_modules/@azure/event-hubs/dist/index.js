...
(function (ConnectionContext) {
    ...
    function create(config, tokenCredential, options) {
        ...
        let waitForDisconnectResolve;
        let waitForDisconnectPromise;
...
class GreedyPartitionLoadBalancer {
    ...
    loadBalance(_ownerId, _partitionOwnershipMap, partitionsToAdd) {
...
class EventHubConsumerClient {
    ...
    createEventProcessorForAllPartitions(subscriptionEventHandlers, options) {
        ...
        const eventProcessor = this._createEventProcessor(this._context, subscriptionEventHandlers, this._checkpointStore, Object.assign(Object.assign(Object.assign({}, defaultConsumerClientOptions), options), { ownerLevel: getOwnerLevel(options, this._userChoseCheckpointStore), processingTarget: this._userChoseCheckpointStore
                ? undefined
            ...
            ownerId: this._id, retryOptions: this._clientOptions.retryOptions }));
